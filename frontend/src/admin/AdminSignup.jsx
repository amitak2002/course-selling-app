...
function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('error comes at : ',err)
    ...
    <div className="bg-gradient-to-r from-black to-blue-900 min-h-screen">
      ...
      <div className="text-white container mx-auto">
          ...
          <header className="flex justify-between items-center container mx-auto py-8">
            ...
            <div className="flex items-center">
              <Link to="/admin/signin" className="border-2 border-white mx-2 py-2 px-4 rounded-md font-bold hover:bg-orange-600 transition duration-300">
                Login
              </Link>
              <Link to="/admin/dashboard" className="border-2 border-white mx-2 py-2 px-4 rounded-md font-bold hover:bg-orange-600 transition duration-300">
                join now
              </Link>
            </div>
          </header>
          ...
          <div className='py-12 px-8 border-2 border-gray-600 rounded-md bg-gray-800'>
            <div className='flex justify-center items-center'>
              <div>
                ...
                <p className='text-md font-semibold flex justify-center items-center my-2 text-gray-500'>Just_Sign_Up_first_Admin_</p>
              </div>
            </div>
